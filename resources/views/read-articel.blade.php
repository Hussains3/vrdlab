...
<section class="article-hero_area">
    <div class="container">
        ...
        <div class="article_author_info">
            <p><span>by,</span>
                @foreach ($article->authours as $author)
...
$("#copy-btn").on('click', function() {
    navigator.clipboard.writeText($("#articleUrl").val());
